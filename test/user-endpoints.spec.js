    ...
    describe(`Given a valid user`, () => {
      ...
      it(`inserts 1 language with words for the new user`, () => {
        ...
        const expectedList = {
          ...
          total_score: 0,
          words: [
            { original: 'die Frau', translation: 'woman, wife' },
            { original: 'der Mann', translation: 'man, husband' },
            { original: 'das Kind', translation: 'child' },
            { original: 'die Eltern', translation: 'parents' },
            { original: 'die Leute', translation: 'people' },
            { original: 'die Erde', translation: 'earth' },
            { original: 'das Land', translation: 'country' },
            { original: 'der Name', translation: 'name' },
            { original: 'schön', translation: 'beautiful' },
            { original: 'leben', translation: 'to live' },
          ],
        };
        return supertest(app)
          .post('/api/user')
